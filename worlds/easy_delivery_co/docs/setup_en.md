...
- [Easy Delivery Co. Randomizer Mod]()
...
Download the latest release of the [Easy Delivery Mod]() and the latest release of the [Easy Deliver API](https://github.com/foxfoxfoxgay/EasyDeliveryAPI/releases/tag/1.0.0).
...
The filepath to the mode should look like `BepInEx/plugins/EasyDeliveryAP`<br>
